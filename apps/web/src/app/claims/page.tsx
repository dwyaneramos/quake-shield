        ...
        <div className="bg-white rounded-xl shadow-sm border border-ink-100">
          ...
          {!isConnected ? (
            <div className="p-8 text-center text-ink-500">
              <p className="mb-4">
                Connect your wallet to see your claims history.
              </p>
            ...
            <div className="p-8 text-center text-ink-500">
              <svg
                className="w-12 h-12 mx-auto mb-4 text-ink-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-ink-500 mb-4">
                When an earthquake triggers your policy, the payout appears
                here.
              </p>
              <Link
                href="/policies/new"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-ink-900">
                        {SCALE.fromUSDC(claim.amount).toLocaleString()} USDC
                        paid out
                      </p>
                      <p className="text-sm text-ink-500">
                        {getMagnitudeLabel(magnitude)} quake · Policy #
                        {claim.policyId.toString()} · Block{" "}
